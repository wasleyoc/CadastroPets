...
public class CadastroPets {
    public static void Cadastrar(Scanner scanner) throws FileNotFoundException {
        ...
        try (BufferedReader lerArq = new BufferedReader(new FileReader(path));
            ...
            while ((linha = lerArq.readLine()) != null) {
                ...
                // Este trecho trata a entrada do usuário para os campos específicos do
                // formulário:
                // Se for a pergunta do tipo do pet, força a escolha entre cachorro ou gato
                // usando enum.
                // Se for a pergunta do sexo do pet, força a escolha entre macho ou fêmea usando
                // enum.
                // Para as demais perguntas, solicita uma resposta livre e preenche "Não
                // Informado" se estiver em branco.
                if (pergunta == 1) {
                    PetsType tipo = null;
                    do {
